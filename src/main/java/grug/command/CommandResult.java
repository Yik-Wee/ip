...
public sealed interface CommandResult {
    /**
     * Getter for {@code message} which is generated by default by each record.
     *
     * @return The CommandResult's message.
     */
    public String message();

    /**
     * Getter for {@code shouldExit} which is generated by default by each record.
     *
     * @return {@code true} if program should exit, {@code false} otherwise.
     */
